...
const CACHE_NAME = "test1-cache";
const OFFLINE_URL = "test1.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["test1.html","test1.js","test1.wasm","test1.pck","test1.offline.html","test1.icon.png","test1.apple-touch-icon.png"];
